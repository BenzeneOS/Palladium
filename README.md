...
cd src
git checkout 149.0.7827.22  # current stable version
...
Note: Patches 0214-0218 set up automatic application of subproject patches (v8, search_engines_data) via gclient hooks. The Kagi search engine patch is the final Palladium-specific patch in the series.
